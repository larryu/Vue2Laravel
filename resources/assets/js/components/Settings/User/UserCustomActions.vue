<template>
    <div>
        <div class="user-custom-actions text-center">
...
<script>
    export default {
        ...
        updated() {
            console.log('UserCustomActions Component updated.');
        },
        created() {
            console.log('UserCustomActions created: ', this.rowData, this.rowIndex);
        },
        methods: {
