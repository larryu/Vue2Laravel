...
<script>
    import Vue from 'vue';
    import StateCustomActions from './StateCustomActions.vue'
    ...
    export default {
        ...
        created() {
            console.log('StateListView Component created.')
        },
        updated() {
            console.log('StateListView Component updated.')
        },
        components: {
            'state-list-view-actions': StateCustomActions,
        },
        mounted() {
            console.log('StateListView Component mounted.')
        },
        methods: {
            onClickNew() {
